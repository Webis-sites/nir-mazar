      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button onClick={handlePrev} className="bg-white/70 hover:bg-blue-100 text-blue-600 rounded-full w-10 h-10 flex items-center justify-center shadow transition-all">
              <IoIosArrowBack className="text-xl" />
            </button>
            <button onClick={handleNext} className="bg-white/70 hover:bg-blue-100 text-blue-600 rounded-full w-10 h-10 flex items-center justify-center shadow transition-all">
