...
const FAQSection: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'ניתן לקבוע שיעור באמצעות שיחת טלפון או הודעת וואטסאפ למספר 050-1234567. אנו פועלים בימים א׳-ה׳ בין השעות 08:00-20:00 ובימי שישי בין 08:00-14:00. מומלץ לקבוע שיעורים מראש לפחות שבוע מראש, במיוחד בתקופות עמוסות.'
    }
  ];
